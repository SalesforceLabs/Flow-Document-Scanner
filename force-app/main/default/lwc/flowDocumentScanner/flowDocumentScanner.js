...
export default class FlowDocumentScanner extends LightningElement {
    // Scan results (if any)
    scannerError;
    scannedDocument;
    @api scannedText;
    @api scannerInstructions = 'Select source of document to be scanned:';
    @api showResults;
    ...
    processScannedDocuments(documents) {
      ...
      this.scannedText = this.scannedDocument.text;
      this.dispatchEvent(new FlowAttributeChangeEvent('scannedText',this.scannedText));
